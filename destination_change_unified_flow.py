...
def build_optimizer_input_direct_from_plan(
    ...
    out["F Wk3"] = 0.0
    # SI logic applies the same formula for all warehouses.
    # Whse 335 uses accumulated forecast subtraction through Target Week.
    ...
    build_debug = pd.DataFrame([
        ...
        ["Whse 335 SI logic", "SI(Target Week) - Planned POS(First ETD week -> Target Week) - Firm POS(Target Week) - Acc Forecast(Current Week -> Target Week)."],
...
def transform_converted_plan_to_optimizer_input(
    ...
    debug_rows = [
        ...
        ["Firm PO Reconciliation Gap total", str(float(output["Firm PO Reconciliation Gap"].sum())) if "Firm PO Reconciliation Gap" in output.columns else "0"],
        ["Total Supply Added to SI", str(float(output["Total Supply Added to SI"].sum())) if "Total Supply Added to SI" in output.columns else str(float(output["F Wk3"].sum()))],
        ["Whse 335 SI logic", "SI(Target Week) - Planned POS(First week -> Target Week) - Firm POS(Target Week) - Acc Forecast(Current Week -> Target Week)."],
